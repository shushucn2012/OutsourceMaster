...
/**
 * Created by shubei on 2017/9/22.
 */

public class JoinLoginActivity extends BaseActivity {

    private Button btn_get_vcode, btn_comit;
    private EditText edit_p_mobile, edit_checkcode, edit_p_name;
    private AccoutSafeTimeTextView ttv_time;

    private String mobile, vcode, username, stime;
    ...
    protected boolean validateReg() {
        username = edit_p_name.getText().toString().trim();
        mobile = edit_p_mobile.getText().toString().trim();
