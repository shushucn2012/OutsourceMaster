...
public class ImageManager {
     ...
     * @param picUrl    图片url
     */
    public void displayImg(Context context, ImageView imageView, String picUrl) {
     ...
     * @param picUrl    图片url
     */
    public void displayUserHeadImg(ImageView imageView, String picUrl) {
        DisplayImageOptions options = new DisplayImageOptions.Builder()
                .showImageForEmptyUri(R.mipmap.morentouxiang)
                .showImageOnLoading(R.mipmap.morentouxiang)
                .showImageOnFail(R.mipmap.morentouxiang)
